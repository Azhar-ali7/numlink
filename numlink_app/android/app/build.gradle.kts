...
android {
    ...
    compileOptions {
        // Required by flutter_local_notifications: it schedules through the
        // java.time APIs, which need desugaring on older Android versions.
    ...
    defaultConfig {
        ...
        applicationId = "com.numlink.numlink_app"
